...
class CampusMap extends StatefulWidget {
  ...
  const CampusMap({super.key, required this.onTap, this.guessLocation});
...
class _CampusMapState extends State<CampusMap> with TickerProviderStateMixin {
  ...
  _bounceController; // Added bounce animation for better UX
  ...
  void didUpdateWidget(CampusMap oldWidget) {
    ...
    if (widget.guessLocation != null &&
        oldWidget.guessLocation != widget.guessLocation) {
      ...
      child: ClipRRect(
        ...
        child: FlutterMap(
          options: MapOptions(
            ...
            cameraConstraint:
                CameraConstraint.unconstrained(), // Removed restrictive camera constraint to prevent assertion errors
